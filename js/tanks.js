...
function init()  {
  game = new Phaser.Game(window.innerWidth/2, window.innerHeight-20, Phaser.AUTO, 'phaser-example', { preload: preload, create: create, update: update, render: render });
}
init();
...
function create () {
    ...
    // land2 = game.add.tileSprite(800, 600, 2000, 2000, 'grass');
...
function update () {
    ...
    if (cursors.up.isDown || upKey.isDown)
    {
        ...
        currentSpeed = Math.min(currentSpeed += 30, 300);
